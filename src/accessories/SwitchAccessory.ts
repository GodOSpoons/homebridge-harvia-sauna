...
import { PlatformAccessory, Logger, CharacteristicValue, API, Characteristic } from 'homebridge';
...
export class SwitchAccessory implements DeviceStateSubscriber {
  ...
  private getCurrentState(): boolean {
    switch (this.type) {
      ...
      case 'light':
        return this.device.lightsOn;
      case 'fan':
        return this.device.fanOn;
      case 'steamer':
        return this.device.steamOn;
    }
  }
